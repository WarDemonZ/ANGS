 ...
 */
  ...
  $simplenews_nid = $params['simplenews_source']->getNode()->nid;
  $simplenews_source = node_load($simplenews_nid);
?>
        ...
        <tr>
          <td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">
            ...
            <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
              <tbody>
                <tr>
                  <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;color: #5F5F5F;font-size: 14px;line-height: 125%;text-align: center;">
                     <a href="<?php echo url('node/' . $simplenews_nid, array('absolute' => TRUE)); ?>" target="_blank">Click here to view this online</a>
                  </td>
                </tr>
              </tbody>
            </table>
        ...
        <tr>
          <td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">
            ...
            <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
              <tbody>
                <tr>
                  <td valign="top" class="mcnTextContent" style="padding: 0px 40px 9px;color: #5F5F5F;font-size: 14px;line-height: 125%;">
                    <?php echo $body; ?>
                  </td>
                </tr>
                <tbody>
                <tr>
                  <td valign="top" class="mcnTextContent signature" style="padding: 0px 40px 9px;color: #33b7a0;font-size: 32px;line-height: 125%;">
                    <?php $user = user_load($simplenews_source->uid); print $user->realname; ?>
                  </td>
                </tr>
              </tbody>
            </table>
